...
const $events = {
     ...
     * **NOTE:**
     *
     * This parameter is always `true` for direct connections (created by calling {@link Database#connect Database.connect}
     ...
     * @event task
     * @description
     * Global notification of a task start / finish events, as executed via {@link Database#task Database.task}.
     *
     * The library will suppress any error thrown by the handler and write it into the console.
     *
     * @param {EventContext} e
